...
class ManagerComponent extends StatefulWidget {
  @override
  _ManagerComponentState createState() => _ManagerComponentState();
}

class _ManagerComponentState extends State<ManagerComponent> {
  @override
          ...
          return InTouchWidget(
              ...
              callback: () {
                Navigator.of(context)
                    .pushNamed(RoutePath.capitalSubmissionWidget);
              },
              child: Container(
                decoration: BoxDecoration(
                    color: Color(0xFFF9FB9E),
