...
class FieldComponent extends StatefulWidget {
  ...
  final bool isPhone;
  FieldComponent({this.controller,this.labelText,this.maxLines,this.maxLength,this.keyboardType = TextInputType.text,this.onTap,this.isPhone=false,this.onTapCountry});
    ...
    return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            else widget.onTap!=null?InkWell(
              onTap: (){},
              child:  Icon(Icons.arrow_drop_down,size:  Theme.of(context).textTheme.headline3.fontSize,color: ColorConfig.greyPrimary,),
            ):null,
          ],
        )
    );
  ...
  Widget renderField({BuildContext context}){
    ...
    return TextFormField(
      ...
      inputFormatters: <TextInputFormatter>[
        if(widget.keyboardType==TextInputType.number) WhitelistingTextInputFormatter.digitsOnly,
