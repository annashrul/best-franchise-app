...
class _RoyaltiWidgetState extends State<RoyaltiWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return WrapperRewardComponent(
      ...
      rewardCard: GeneralHelper().formatter.format(int.parse(reward.infoModel.data.saldoRoyalti)),
  ...
  Widget buildContent(BuildContext context){
    ...
    if(data.isLoadingList) return BaseLoadingLoop(
    ...
    return ListView.separated(
        ...
        itemBuilder: (context,index){
          ...
          return CardKomisiRoyalti(
            title: "Royalti untuk kamu : Rp. ${GeneralHelper().formatter.format(int.parse(val.nominal))}\nDari Outlet Atas nama ${val.downline}",
            subtitle: val.msg,
